...
\section{Results}
\begin{center}
\captionof{table}{Performance Metrics Across Variants. Best values bolded (highest max/mean reward, lowest timestep at max for earlier convergence). Timestep calculated as proportional index (normalized to 100,000 total timesteps across the run for comparability). Mean and std computed over all episodes in the run.}
\resizebox{\textwidth}{!}{
\begin{tabular}{|l|c|c|c|c|c|c|c|c|c|}
\hline
Environment & \multicolumn{3}{c|}{Max Reward} & \multicolumn{3}{c|}{Mean Reward ($\pm$ std)} & \multicolumn{3}{c|}{Timestep at Max} \\
\cline{2-10}
 & TRPO & GenTRPO & GenTRPO w/ Noise & TRPO & GenTRPO & GenTRPO w/ Noise & TRPO & GenTRPO & GenTRPO w/ Noise \\
\hline
Humanoid-v5 & 4.95 & 5.25 & \textbf{5.29} & $4.76 \pm 0.14$ & \textbf{$4.94 \pm 0.22$} & $4.92 \pm 0.20$ & \textbf{42857} & 95408 & 90816 \\
\hline
HumanoidStandup-v5 & 85.94 & \textbf{283.75} & 229.41 & $60.15 \pm 11.13$ & $68.20 \pm 21.69$ & \textbf{$69.26 \pm 24.21$} & 62245 & 99400 & \textbf{59891} \\
\hline
\end{tabular}
}
\end{center}
...
\captionof{figure}{Rewards and Entropies for GenTRPO w/ Noise in Humanoid-v5.}
\end{center}
...
\captionof{figure}{Rewards and Entropies for GenTRPO in HumanoidStandup-v5.}
\end{center}
