...
if __name__ == "__main__":
  ...
  models = config.get("models", [GenTRPO, GenPPO, TRPO, PPO, TRPOR])
  ...
  for model_class in models:
    ...
    with open(f".noise/{run_date}/{model_class.__name__}_{total_timesteps}_reward_action_{num_runs}_runs.yml", "w") as file:
